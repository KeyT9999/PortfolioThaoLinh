    ...
    >
      {cardOrder.map((originalIndex, displayIndex) => {
        ...
        return (
          <article
            key={card.id}
            className="image-card absolute cursor-grab active:cursor-grabbing place-self-center border-2 border-slate-700 dark:border-gray-600 rounded-2xl shadow-lg overflow-hidden will-change-transform bg-slate-800 dark:bg-gray-800"
            style={{
